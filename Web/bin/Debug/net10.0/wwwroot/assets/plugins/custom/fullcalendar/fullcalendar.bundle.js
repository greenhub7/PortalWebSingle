...
var FullCalendar = (function (exports) {
    ...
    var MorePopover =  (function (_super) {
        ...
        MorePopover.prototype.render = function () {
            ...
            return (createElement(DayCellRoot, { date: startDate, dateProfile: dateProfile, todayRange: todayRange, elRef: this.handleRootEl }, function (rootElRef, dayClassNames, dataAttrs) { return (createElement(Popover, { elRef: rootElRef, id: props.id, title: title, extraClassNames: ['fc-more-popover'].concat(dayClassNames), extraAttrs: dataAttrs , parentEl: props.parentEl, alignmentEl: props.alignmentEl, alignGridTop: props.alignGridTop, onClose: props.onClose },
    ...
    var MoreLinkRoot =  (function (_super) {
        ...
        MoreLinkRoot.prototype.render = function () {
            ...
            return (createElement(ViewContextType.Consumer, null, function (context) {
                ...
                var text = typeof moreLinkText === 'function' 
                ...
                for (var dayIndex = 0; dayIndex < segsByDay.length; dayIndex += 1) {
                    ...
                    if (daySegs) { 
                        ...
                        for (var _i = 0, daySegs_1 = daySegs; _i < daySegs_1.length; _i++) {
                            ...
                            innerNodes.push(createElement(ListViewEventRow, __assign({ key: dayStr + ':' + seg.eventRange.instance.instanceId , seg: seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: false, timeHeaderId: timeHeaderId, eventHeaderId: eventHeaderId, dateHeaderId: dateHeaderId }, getSegMeta(seg, todayRange, nowDate))));
                        }
                    }
                }
    ...
    var BootstrapTheme$1 =  (function (_super) {
    ...
    BootstrapTheme$1.prototype.iconOverrideOption = 'bootstrapFontAwesome'; 
